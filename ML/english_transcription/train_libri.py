...
while global_step<total_steps:
    ...
    train_loss = []
    train_ler = []
    for batch_data,batch_label in tqdm(train_set,total = valid_step-1):
    ...
    for batch_data,batch_label in tqdm(valid_set,total = len(valid_set)):
    ...
    print(f'Current Step: {global_step}. Current Val Avg loss: {sum(val_loss)/len(val_loss)}. Total step: {total_steps}.')
    print(f'Current Step: {global_step}. Current Val Avg ler: {sum(val_ler)/len(val_ler)}. Total step: {total_steps}.')
